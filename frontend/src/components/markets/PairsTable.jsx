...
export function PairsTable({ searchQuery = '' }) {
  ...
  const { data: marketData, loading, error, lastUpdate } = useHyperliquidMarkets();
      ...
      <div className="p-8">
          ...
          <table className="w-full">
            <thead className="bg-muted/50">
              <tr className="text-left">
                ...
                >
                  Funding APR {sortBy === 'fundingRate' && (sortOrder === 'asc' ? '↑' : '↓')}
                </th>
                    ...
                    <td className="p-4">
                      <div className="flex items-center justify-center gap-3">
                        ...
                        <Button 
                          ...
                          onClick={(e) => {
                            e.stopPropagation();
                            window.open(`https://app.hyperliquid.xyz/trade/${pair.base}`, '_blank');
                          }}
                        >
        ...
        {filteredData.length === 0 && !loading && (
          <div className="text-center py-12 text-muted-foreground">
            <p className="text-lg">No trading pairs found matching your search.</p>
          </div>
        )}
        </div>
      </div>
