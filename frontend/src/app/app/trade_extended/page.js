...
const API = {
  trade: '/api/hl/trading/orders/open',
  leverage: '/api/hl/trading/leverage',
  activeAssetData: '/api/hl/trading/active-asset-data',
  state: '/api/hl/trading/state',
  marketClose: '/api/hl/trading/orders/market-close',
};
