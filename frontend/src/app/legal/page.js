...
export default function LegalPage() {
  const legalPages = [
    ...
    },
    {
      ...
      description: 'Important information about trading risks and potential losses',
      ...
      <div className="container mx-auto px-4 py-16 max-w-6xl">
        <div className="text-center space-y-6 mb-12">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Important legal documents and disclosures for using the Aequilibra platform
          </p>
        </div>
        ...
        <div className="mt-16 text-center space-y-4">
          <div className="bg-muted p-6 rounded-lg max-w-2xl mx-auto">
            ...
            <p className="text-sm text-muted-foreground mb-4">
              If you have questions about our legal documents or need clarification, 
              please don&apos;t hesitate to contact us.
            </p>
            <div className="space-y-1 text-sm">
              <p><strong>Email:</strong> legal@aequilibra.com</p>
